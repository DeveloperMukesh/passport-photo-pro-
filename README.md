...
```bash
https://github.com/DeveloperMukesh/passport-photo-pro
...
- **remove.bg**: Sign up at [remove.bg](https://www.remove.bg/api) to get a free API key (50 free previews/month)
...
## 👨‍💻 Author
Mukesh Nath  
Website: https://mukeshnath.com.np/

## 📜 License
This project is licensed under the MIT License - see the LICENSE file for details.

Original Author: Mukesh Nath